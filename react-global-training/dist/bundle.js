...
var AppPure = function (_PureComponent) {
  _inherits(AppPure, _PureComponent);

  function AppPure() {
    _classCallCheck(this, AppPure);

    return _possibleConstructorReturn(this, (AppPure.__proto__ || Object.getPrototypeOf(AppPure)).apply(this, arguments));
  }

  _createClass(AppPure, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
...
var _AppPure = __webpack_require__(/*! ./AppPure */ "./AppPure.js");

var _AppPure2 = _interopRequireDefault(_AppPure);

var _registerServiceWorker = __webpack_require__(/*! ./registerServiceWorker */ "./registerServiceWorker.js");
...
var HelloWorld = _react2.default.createElement("h1", null, "Hello React.createElement!", _react2.default.createElement(_App2.default, null), _react2.default.createElement(_AppPure2.default, null), _react2.default.createElement(HelloWorldFunctional, null));

_reactDom2.default.render(HelloWorld, document.getElementById('root'));
